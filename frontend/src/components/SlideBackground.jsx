...
//                     <div
//                         key={i}
//                         className=" min-w-full h-60 sm:h-48 md:h-76 lg:h-94 snap-start relative shrink-0 ">
//                         <img
//                             src={img}
...
//                             <div className="text-white text-lg md:text-2xl font-bold max-w-xs md:ml-4">
//                                 <span className='border text-text-dark bg-secondary text-xs md:text-sm px-2 py-1 rounded-lg'>Exclusive</span>
//                                 <h1 className='text-white'>The Summer Edit is Here</h1>
//                                 <span className='text-text-light text-sm md:text-md'>Curated for excellance</span>

//                             </div>
//                             <button className="mt-3 md:ml-4 bg-primary text-white text-xs md:text-sm px-4 py-2 rounded-lg w-max">
//                                 Shop Now
//                             </button>
//                         </div>
//                     </div>
